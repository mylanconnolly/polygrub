...
export function Navbar({ email }: { email: string }) {
  ...
  return (
    <header>
      <nav aria-label="Main navigation" className="border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
        ...
        {/* Mobile menu */}
        {mobileOpen && (
          <div id="mobile-menu" className="border-t border-zinc-200 px-4 py-3 sm:hidden dark:border-zinc-800">
